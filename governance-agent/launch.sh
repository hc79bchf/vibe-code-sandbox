...
if [ ! -f "$SCRIPT_DIR/.env" ]; then
    ...
    echo "  1. Clone your project repo:  git clone <repo-url> ~/projects/governance-agent"
...
echo "To disable Vibe Guard: docker exec -it governance-sandbox bash -c 'cd /workspace && ~/disable-vibe-guard.sh'"
